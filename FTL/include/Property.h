...
namespace FTL
{
	...
	class PropertyBindTypeBase;

	template <class Type>
	class PropertyBindTypeBase<Type, PropertyType::AutoGen>
	{
	public:
		using BaseType = PropertyGetterSetterBase<Type>;
	};

	template <class Type>
	class PropertyBindTypeBase<Type, PropertyType::Manual>
	{
	public:
		using BaseType = PropertyGetterSetterBase<Type>;
	};
	...
	template <class Type>
	class PropertyBindTypeBase<Type, PropertyType::GetterOnly>
	{
	public:
		using BaseType = PropertyGetterBase<Type>;
	};

	template <class Type>
	class PropertyBindTypeBase<Type, PropertyType::SetterOnly>
	{
	public:
		using BaseType = PropertySetterBase<Type>;
	};

	template <class Type, PropertyType PropType>
	using PropertyBindType = typename PropertyBindTypeBase<Type, PropType>::BaseType;

	// Constructor
	template <class Type, PropertyType PropType>
	class PropertyConstructor : public PropertyBindType<Type, PropType>
	{
	public:
		using Parent = PropertyBindType<Type, PropType>;

		using Parent::Parent;
	};

	template <class Type>
	class PropertyConstructor<Type, PropertyType::AutoGen> : public PropertyBindType<Type, PropertyType::AutoGen>
	{
	public:
		using Parent = PropertyBindType<Type, PropertyType::AutoGen>;
